...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.EventPolicy, desiredFinalizers sets.Set[string]) (*v1alpha1.EventPolicy, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.EventPolicy, desiredFinalizers sets.Set[string]) (*v1alpha1.EventPolicy, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.EventPolicy, reconcileEvent reconciler.Event) (*v1alpha1.EventPolicy, error) {
	...
	if err != nil {
		...
		getter := r.Client.EventingV1alpha1().EventPolicies(resource.Namespace)
