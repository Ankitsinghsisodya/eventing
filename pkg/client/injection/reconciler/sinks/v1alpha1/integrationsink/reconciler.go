...
// controller reconciling v1alpha1.IntegrationSink.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.IntegrationSink. Any changes
	...
	ReconcileKind(ctx context.Context, o *v1alpha1.IntegrationSink) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.IntegrationSink.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.IntegrationSink. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.IntegrationSink) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1alpha1.IntegrationSink if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.IntegrationSink.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.IntegrationSink) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.IntegrationSink) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1alpha1.IntegrationSink resources.
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sinksv1alpha1.IntegrationSinkLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.IntegrationSinks(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.IntegrationSink, desired *v1alpha1.IntegrationSink) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.SinksV1alpha1().IntegrationSinks(desired.Namespace)
		...
		updater := r.Client.SinksV1alpha1().IntegrationSinks(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.IntegrationSink, desiredFinalizers sets.Set[string]) (*v1alpha1.IntegrationSink, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.IntegrationSink, desiredFinalizers sets.Set[string]) (*v1alpha1.IntegrationSink, error) {
	...
	patcher := r.Client.SinksV1alpha1().IntegrationSinks(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.IntegrationSink, desiredFinalizers sets.Set[string]) (*v1alpha1.IntegrationSink, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.IntegrationSink) (*v1alpha1.IntegrationSink, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.IntegrationSink, reconcileEvent reconciler.Event) (*v1alpha1.IntegrationSink, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
	...
	if err != nil {
		...
		getter := r.Client.SinksV1alpha1().IntegrationSinks(resource.Namespace)
