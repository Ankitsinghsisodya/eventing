...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1.Channel, desired *v1.Channel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Channel, desiredFinalizers sets.Set[string]) (*v1.Channel, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1.Channel, desiredFinalizers sets.Set[string]) (*v1.Channel, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1.Channel, desiredFinalizers sets.Set[string]) (*v1.Channel, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1.Channel, reconcileEvent reconciler.Event) (*v1.Channel, error) {
	...
	if err != nil {
		...
		getter := r.Client.MessagingV1().Channels(resource.Namespace)
