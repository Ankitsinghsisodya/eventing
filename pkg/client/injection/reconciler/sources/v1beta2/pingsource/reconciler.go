...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta2.PingSource, desired *v1beta2.PingSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta2.PingSource, desiredFinalizers sets.Set[string]) (*v1beta2.PingSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta2.PingSource, desiredFinalizers sets.Set[string]) (*v1beta2.PingSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta2.PingSource, desiredFinalizers sets.Set[string]) (*v1beta2.PingSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta2.PingSource, reconcileEvent reconciler.Event) (*v1beta2.PingSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1beta2().PingSources(resource.Namespace)
